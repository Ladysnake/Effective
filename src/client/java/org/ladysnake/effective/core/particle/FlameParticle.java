...
public class FlameParticle extends LodestoneWorldParticle {
	public FlameParticle(ClientWorld world, WorldParticleOptions data, FabricSpriteProviderImpl spriteSet, double x, double y, double z, double xd, double yd, double zd) {
