...
public class WreathModel extends OverheadModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData1.addChild("wreath", ModelPartBuilder.create().texture(0, 0).cuboid(-5.0F, -34.5F, -5.0F, 10.0F, 5.0F, 8.0F, new Dilation(0.5f)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
