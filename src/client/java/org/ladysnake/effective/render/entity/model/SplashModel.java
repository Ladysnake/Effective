...
public class SplashModel<T extends Entity> extends EntityModel<T> {
	public static final EntityModelLayer MODEL_LAYER = new EntityModelLayer(Identifier.of(Effective.MODID, "splash"), "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild("splash", ModelPartBuilder.create().texture(0, 0).cuboid(-6.0F, -16.0F, -6.0F, 12.0F, 16.0F, 12.0F), ModelTransform.pivot(0.0F, 16.0F, 0.0F));
