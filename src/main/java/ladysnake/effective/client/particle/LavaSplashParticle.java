...
public class LavaSplashParticle extends Particle {
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        if (age <= this.wave1End) {
            ...
            RenderLayer layer1 = EffectiveRenderLayers.glowwy(new Identifier(Effective.MODID, "textures/entity/splash/lava_splash_" + frame1 + ".png"));
        ...
        if (age >= this.wave2Start) {
            ...
            RenderLayer layer2 = EffectiveRenderLayers.glowwy(new Identifier(Effective.MODID, "textures/entity/splash/lava_splash_" + frame2 + ".png"));
