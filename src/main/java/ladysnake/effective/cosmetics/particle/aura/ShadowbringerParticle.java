...
import ladysnake.effective.particle.ChorusPetalParticle;
...
public class ShadowbringerParticle extends ChorusPetalParticle {
	...
	public void tick() {
		...
		if (this.onGround || this.world.getFluidState(new BlockPos((int) this.x, (int) this.y, (int) this.z)).getFluid() != Fluids.EMPTY) {
			this.velocityY *= 0.95;
		}
