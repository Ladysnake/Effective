...
public class GlowWaterfallCloudParticle extends WaterfallCloudParticle {
	...
	public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
		...
		vertexConsumer.vertex(Vec3fs[0].getX(), Vec3fs[0].getY(), Vec3fs[0].getZ()).uv(maxU, maxV).color(redAndGreenRender, redAndGreenRender, blue, 1.0f).light(l).next();
		vertexConsumer.vertex(Vec3fs[1].getX(), Vec3fs[1].getY(), Vec3fs[1].getZ()).uv(maxU, minV).color(redAndGreenRender, redAndGreenRender, blue, 1.0f).light(l).next();
		vertexConsumer.vertex(Vec3fs[2].getX(), Vec3fs[2].getY(), Vec3fs[2].getZ()).uv(minU, minV).color(redAndGreenRender, redAndGreenRender, blue, 1.0f).light(l).next();
		vertexConsumer.vertex(Vec3fs[3].getX(), Vec3fs[3].getY(), Vec3fs[3].getZ()).uv(minU, maxV).color(redAndGreenRender, redAndGreenRender, blue, 1.0f).light(l).next();
	}
